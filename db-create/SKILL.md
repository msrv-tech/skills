...
```powershell
powershell.exe -NoProfile -File <skills-root>/db-create/scripts/db-create.ps1 <параметры>
```
...
powershell.exe -NoProfile -File <skills-root>/db-create/scripts/db-create.ps1 -InfoBasePath "C:\Bases\NewDB"

# Создать серверную базу
powershell.exe -NoProfile -File <skills-root>/db-create/scripts/db-create.ps1 -InfoBaseServer "srv01" -InfoBaseRef "MyApp_Test"

# Создать из шаблона CF
powershell.exe -NoProfile -File <skills-root>/db-create/scripts/db-create.ps1 -InfoBasePath "C:\Bases\NewDB" -UseTemplate "C:\Templates\config.cf"

# Создать и добавить в список баз
powershell.exe -NoProfile -File <skills-root>/db-create/scripts/db-create.ps1 -InfoBasePath "C:\Bases\NewDB" -AddToList -ListName "Новая база"
```
