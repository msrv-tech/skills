...
powershell.exe -NoProfile -File <skills-root>/web-unpublish/scripts/web-unpublish.ps1 -AppName "bpdemo"

# Удалить все публикации
powershell.exe -NoProfile -File <skills-root>/web-unpublish/scripts/web-unpublish.ps1 -All

# С указанием пути
powershell.exe -NoProfile -File <skills-root>/web-unpublish/scripts/web-unpublish.ps1 -AppName "mydb" -ApachePath "C:\tools\apache24"
```
