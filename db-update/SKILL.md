...
```bash
python3 "<skills-root>/db-update/scripts/db-update.py" -InfoBasePath <test-infobase-path>
```

Windows PowerShell остаётся отдельным вариантом запуска:

```powershell
powershell.exe -NoProfile -File "<skills-root>/db-update/scripts/db-update.ps1" -InfoBasePath <test-infobase-path>
```
